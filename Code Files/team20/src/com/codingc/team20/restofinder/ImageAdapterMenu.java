...
public class ImageAdapterMenu extends ArrayAdapter<Integer> {
	private Context mContext;
	 public ArrayList<Integer> bmp = new ArrayList<Integer>();
	...
	// Constructor
	public ImageAdapterMenu(Context c,int layoutResourceId,ArrayList<Integer> bmp){
	...
	public View getView(int position, View convertView, ViewGroup parent) {	
        ...
        imageView.setImageResource(bmp.get(position));
		else
